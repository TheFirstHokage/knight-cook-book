package knight.springframework.cookbook.bootstrap;

import knight.springframework.cookbook.model.*;
import knight.springframework.cookbook.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> dashSpoonUomOpt = unitOfMeasureRepository.findByDescription("Dash");
        if (!dashSpoonUomOpt.isPresent()) {
            throw new RuntimeException("uom not found");
        }


        Optional<UnitOfMeasure> pintSpoonUomOpt = unitOfMeasureRepository.findByDescription("Pint");
        if (!pintSpoonUomOpt.isPresent()) {
            throw new RuntimeException("uom not found");
        }


        Optional<UnitOfMeasure> cupUomOpt = unitOfMeasureRepository.findByDescription("Cup");
        ...
        UnitOfMeasure pintUom = pintSpoonUomOpt.get();
        UnitOfMeasure dashUom = dashSpoonUomOpt.get();
